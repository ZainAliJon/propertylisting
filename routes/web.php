...
Route::middleware('auth')->group(function () {
    Route::get('/', function () {
        $locations = App\Models\Location::all()->count();
        $buildings = App\Models\Building::all()->count();
        $listings = App\Models\Listing::all()->count();
        return view('welcome', compact('locations', 'buildings', 'listings'));
    });
